...
<?php /* WordPress Widget Support */ if (function_exists('dynamic_sidebar') and dynamic_sidebar('main-sidebar')) { } else { ?>
	...
	<li class="sb-about">
		...
		<p><?php printf(__('You have searched the %1$s weblog archives for \'<strong>%2$s</strong>\'. If you are unable to find anything in these search results, you can try one of the following sections.','k2_domain'),'<a href="'.get_settings('siteurl').'">'.get_bloginfo('name').'</a>', get_search_query()) ?></p>
